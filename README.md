# go-update: Build self-updating Go programs [![godoc reference](https://godoc.org/github.com/keygen-sh/go-update?status.png)](https://godoc.org/github.com/keygen-sh/go-update)
